Together these scripts provide an analysis pipeline to examine whether a locus (mutation/genomic site) has an impact on a phenotype and to invetigate the mechanims whereby the locus exerts its effect.
