...
#Example1 with genomic position: bash manager_m1.sh chr5:95665720 BMI_PMID30239722.gz
...
while read line; do echo $line;bash probe_finder_p5.sh $line $a; done < besd_files.list
